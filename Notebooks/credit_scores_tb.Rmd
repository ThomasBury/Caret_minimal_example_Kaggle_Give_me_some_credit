...
Let's play a bit by predicting the probability that somebody will experience financial distress in the next two years. First, I will evaluate if the problem is "big enough to matter" and if companies offering credit services should invest in a solution and to what extend.
